...
static void dw_hdmi_clear_edid(struct drm_connector *connector)
{
	...
	dev_info(hdmi->dev, "dw_hdmi_clear_edid: cached_edid=%d\n", !!hdmi->cached_edid);
...
static bool dw_hdmi_get_edid(struct drm_connector *connector)
{
	...
	dev_info(hdmi->dev, "dw_hdmi_get_edid: ddc=%d cached_edid=%d\n", !!hdmi->ddc, !!hdmi->cached_edid);
...
dw_hdmi_connector_detect(struct drm_connector *connector, bool force)
{
	...
	else if (!dw_hdmi_get_edid(connector))
					  ...
					  struct drm_atomic_state *state)
{
	...
	if (!hdr_metadata_equal(old_state, new_state)) {
		...
		/* Only force a modeset if we're entering or exiting HDR */
		if (!old_state->hdr_output_metadata ||
		    !new_state->hdr_output_metadata)
